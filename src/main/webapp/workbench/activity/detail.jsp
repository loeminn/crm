<jsp:useBean id="user" scope="session" type="com.loemin.crm.settings.domain.User"/>
<jsp:useBean id="a" scope="request" type="com.loemin.crm.workbench.domain.Activity"/>
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        html += "<div class='remarkDiv' style='height: 60px;'>" +
                            ...
                            "<div style = 'position: relative; top: -40px; left: 40px;'><h5>" + n.noteContent + "</h5> <font color='gray'>市场活动</font> <font color='gray'>-</font><b>${a.name}</b><small style='color: gray;'>" + (n.editFlag == 0 ? n.createTime : n.editTime) + " 由" + (n.editFlag == 0 ? n.createBy : n.editBy) + "</small>" +
                            "<div style='position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;'>" +
                            "<a class='myHref' onclick='editRemark(\"" + n.id + "\")'><span class='glyphicon glyphicon-edit' style='font-size: 20px; color: #E6E6E6;'></span></a>" +
                            " &nbsp;&nbsp;&nbsp;&nbsp; <a class='myHref' onclick='deleteRemark(\"" + n.id + "\")'><span class='glyphicon glyphicon-remove'style='font-size: 20px; color: #E6E6E6;'></span></a></div></div></div>";
                    })
                    $("#remarkList-header").after(html);
                }
            })
        }
    </script>
...
<body>
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <input type="text" class="form-control" id="edit-startDate" value="${a.startDate}">
                            </div>
                            <label class="col-sm-2 control-label">结束日期</label>
                            <div class="col-sm-10" style="width: 300px;">
                                <input type="text" class="form-control" id="edit-endDate" value="${a.endDate}">
                            </div>
                        </div>
    ...
    <div style="position: relative; left: 40px; top: -30px;">
        ...
        <div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 700px;">
            ...
            <button type="button" class="btn btn-danger" id="deleteBtn"><span class="glyphicon glyphicon-minus"></span>
                删除
            </button>
        </div>
    </div>
    ...
    <div style="position: relative; top: 30px; left: 40px;" id="remarkBody">
        <div class="page-header" id="remarkList-header">
            <h4>备注</h4>
        </div>
        <div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
            <form role="form" style="position: relative;top: 10px; left: 10px;">
                ...
                <p id="cancelAndSaveBtn" style="position: relative;float: right;right: 30px; top: 10px; display: none;">
