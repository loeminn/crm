<jsp:useBean id="c" scope="request" type="com.loemin.crm.workbench.domain.Clue"/>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '    <td>' + n.endDate + '</td>'
                        html += '    <td>' + n.owner + '</td>'
                        html += '    <td><a onclick="unbund(\'' + n.id + '\') " style="text-decoration: none;"><span'
...
<body>
    ...
    <div style="position: relative; top: 35px; left: 10px;">
        <a onclick="window.history.back();"><span class="glyphicon glyphicon-arrow-left"
    ...
    <div style="position: relative; top: -70px;">
        ...
        <div style="position: relative; left: 40px; height: 30px; top: 10px;">
            ...
            <div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${c.company}</b>
            </div>
        ...
        <div style="position: relative; left: 40px; height: 30px; top: 30px;">
            ...
            <div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${c.website}</b>
            </div>
    ...
    <div>
        <div style="position: relative; top: 60px; left: 40px;">
            ...
            <div>
                <a id="bundBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
            </div>
        </div>
    </div>
